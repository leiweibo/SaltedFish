##### COPY FROM https://github.com/maineffort/spring-petclinic-microservices-swagger, THANKS!!!

# Distributed version of the Spring PetClinic Sample Application built with Spring Cloud - Swaggerized Version
